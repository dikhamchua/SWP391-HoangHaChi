...
<div class="kr-page">
    ...
    <div class="kr-page-header">
        <div>
            <div style="font-size:13px;color:#6b7280;margin-bottom:4px;">
                ...
                <span>Tao phieu nhap</span>
            </div>
            <h1 class="kr-page-title">Tao phieu nhap moi</h1>
        </div>
        <div>
            <a href="${ctx}/admin/purchases" class="kr-btn">Quay lai</a>
        </div>
    </div>
    ...
    <div class="kr-main">
        ...
        <section class="kr-content" style="padding:24px;">
            <form method="post" action="${ctx}/admin/purchases" id="poForm" onsubmit="return validatePO();">
                        ...
                        <div>
                            ...
                            <select name="supplierId" class="kr-filter-select" style="width:100%;" required>
                                ...
                                <c:forEach var="sup" items="${suppliers}">
                                    <option value="${sup.supplierId}"><c:out value="${sup.name}" /></option>
                                </c:forEach>
                            </select>
                        </div>
                        <div>
...
<!-- product list (id, name, sku, costPrice) for the dropdown -->
<script>
    var PRODUCTS = [
