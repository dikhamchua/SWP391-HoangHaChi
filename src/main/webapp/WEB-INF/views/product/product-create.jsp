...
<div class="kr-page">
    <div class="kr-main">
        <aside class="kr-sidebar">
            ...
            <a href="${pageContext.request.contextPath}/admin/products?action=create" style="display:flex; align-items:center; gap:10px; padding:10px 16px; font-size:13px; color:#0070f4; font-weight:600; background:#e6f1fe; text-decoration:none;">
        ...
        <div class="kr-content" style="border:none; background:transparent; overflow:visible;">
            ...
            <h1 class="kr-page-title" style="margin-bottom:16px;">Thêm mới hàng hóa</h1>
                ...
                <div style="background:#fff; border-radius:8px; border:1px solid #e8eaed; padding:24px; margin-bottom:16px;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            ...
                            <input type="text" name="sku" required maxlength="50" placeholder="Mã tự động nếu để trống" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                            <span style="font-size:12px; color:#5f6368;">Để trống hệ thống sẽ tự sinh mã</span>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Tên hàng hóa <span style="color:#ef4444;">*</span></label>
                            <input type="text" name="name" required maxlength="200" placeholder="Nhập tên hàng hóa" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                ...
                <div style="background:#fff; border-radius:8px; border:1px solid #e8eaed; padding:24px; margin-bottom:16px;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px;">
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            ...
                            <input type="number" name="price" required min="0" step="1000" placeholder="0" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Giá vốn</label>
                            <input type="number" name="costPrice" min="0" step="1000" value="0" placeholder="0" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Trọng lượng (gram)</label>
                            <input type="number" name="weight" min="0" placeholder="0" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Tồn kho ban đầu</label>
                            <input type="number" name="initialStock" min="0" value="0" placeholder="0" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Tồn kho tối thiểu</label>
                            <input type="number" name="stockAlertQty" min="0" value="0" placeholder="0" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Vị trí</label>
                            <input type="text" name="location" placeholder="Kệ, ngăn..." style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                    </div>
                </div>
                ...
                <div style="background:#fff; border-radius:8px; border:1px solid #e8eaed; padding:24px; margin-bottom:16px;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        <div style="display:flex; flex-direction:column; gap:6px; grid-column:1/-1;">
                            ...
                            <textarea name="description" rows="3" placeholder="Nhập mô tả sản phẩm" style="width:100%; padding:10px 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px; resize:vertical;"></textarea>
                        </div>
                    </div>
                </div>

                <div style="display:flex; align-items:center; gap:12px; padding-top:16px;">
                    <button type="submit" class="kr-btn kr-btn-primary">Lưu hàng hóa</button>
