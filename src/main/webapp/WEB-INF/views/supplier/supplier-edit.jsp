...
<div class="kr-page">
    <div class="kr-main">
        ...
        <div class="kr-content" style="border:none; background:transparent; overflow:visible;">
            ...
            <h1 class="kr-page-title" style="margin-bottom:16px;">Chỉnh sửa nhà cung cấp</h1>
                ...
                <div style="background:#fff; border-radius:8px; border:1px solid #e8eaed; padding:24px; margin-bottom:16px;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            ...
                            <input type="text" name="name" required maxlength="255" value="<c:out value='${supplier.name}'/>" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Số điện thoại</label>
                            <input type="text" name="phone" maxlength="30" value="<c:out value='${supplier.phone}'/>" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            <label style="font-size:13px; font-weight:600;">Email</label>
                            <input type="email" name="email" maxlength="100" value="<c:out value='${supplier.email}'/>" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                        ...
                        <div style="display:flex; flex-direction:column; gap:6px; grid-column:1/-1;">
                            ...
                            <input type="text" name="address" maxlength="255" value="<c:out value='${supplier.address}'/>" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                    </div>
                </div>
