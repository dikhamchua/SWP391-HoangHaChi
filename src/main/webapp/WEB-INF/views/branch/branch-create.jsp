...
<div class="kr-page">
    <div class="kr-main">
        <aside class="kr-sidebar">
            ...
            <a href="${ctx}/admin/branches?action=create" style="display:flex; align-items:center; gap:10px; padding:10px 16px; font-size:13px; color:#0070f4; font-weight:600; background:#e6f1fe; text-decoration:none;">
        ...
        <div class="kr-content" style="border:none; background:transparent; overflow:visible;">
            ...
            <h1 class="kr-page-title" style="margin-bottom:16px;">Thêm mới chi nhánh</h1>
            ...
            <form method="post" action="${ctx}/admin/branches" autocomplete="off">
                ...
                <div style="background:#fff; border-radius:8px; border:1px solid #e8eaed; padding:24px; margin-bottom:16px;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        <div style="display:flex; flex-direction:column; gap:6px;">
                            ...
                            <input type="text" name="name" required maxlength="255" placeholder="Nhập tên chi nhánh" style="width:100%; height:36px; padding:0 12px; border:1px solid #e8eaed; border-radius:6px; font-size:14px;"/>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:6px;">
                ...
                <div style="display:flex; align-items:center; gap:12px; padding-top:16px;">
                    <button type="submit" class="kr-btn kr-btn-primary">Lưu chi nhánh</button>
